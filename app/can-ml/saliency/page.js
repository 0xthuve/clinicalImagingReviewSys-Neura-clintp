...
export default function CancerDetectPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      console.log("Sending request to:", `${API_BASE_URL}/saliency`);
      const response = await axios.post(`${API_BASE_URL}/saliency`, formData, {
    ...
    <div className="min-h-screen bg-gray-100 py-10 px-4">
      <div className="max-w-xl mx-auto bg-white p-6 rounded-2xl shadow-lg">
        <h1 className="text-2xl font-bold text-center text-pink-600 mb-4">
          🧠 Breast Cancer Prediction with Saliency Map
        </h1>
  ...
  <div className="mt-4 space-y-4">
    <div>
      <p className="text-sm text-gray-500 mb-2">Saliency Heatmap:</p>
      <img
    ...
    <div>
      <p className="text-sm text-gray-500 mb-2">Saliency Overlay:</p>
      <img
    ...
    <div>
      <p className="text-sm text-gray-500 mb-2">Saliency Full:</p>
      <img
